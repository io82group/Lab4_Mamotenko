...
while True:
   ...
   #     Y_row_av_arr[l] = round(Y_row_av_arr[l], 3)
    ...
    print(colored("y = {} + {}*x1 + {}*x2 + {}*x3 + {}*x1x2 + {}*x1x3 + {}*x2x3 + {}*x1x2x3 \n".format(list_bi[0], list_bi[1],list_bi[2], list_bi[3],list_bi[4], list_bi[5],list_bi[6], list_bi[7]),"blue"))
    ...
    print(colored("y = {} + {}*x1 + {}*x2 + {}*x3 + {}*x1x2 + {}*x1x3 + {}*x2x3 + {}*x1x2x3".format(list_ai[0], list_ai[1],list_ai[2], list_ai[3],list_ai[4], list_ai[5],list_ai[6], list_ai[7]),"blue"))
    ...
    print(colored("\nGp = {}   Gt = {}".format(Gp,Gt),"magenta"))
    if cohren(Gp, Gt):
        print(colored("Дисперсія однорідна","yellow"))
        ...
        for i in range(len(t_list)):
            if student(t_list[i], T):
                beta_list[i] = 0
                print(colored("Гіпотеза підтверджена, beta{} = 0".format(i),"cyan"))
            else:
                print(colored("Гіпотеза не підтверджена.\nbeta{} = {}".format(i, beta_list[i]),"yellow"))
                d += 1
        ...
        if fisher(Ft, Fp):
            print(colored("Рівняння регресії адекватне","grey"))
            break
        else:
            print(colored("Рівняння регресії неадекватне","white"))
            break

    else:
        print(colored("Дисперсія неоднорідна","white"))
        m += 1
